                            ...
                            <div>
                                ...
                                <div className="pt-4">
                                    <div className="group flex relative">
                                        <Link rel="noopener noreferrer" target="_blank" href={`https://wong-rho.vercel.app/${id}`} className="inline-block bg-gray-200 rounded px-3 py-1 text-sm font-semibold text-gray-700 mb-2">
                                            Chekout how it looks {"->"}
                                        </Link>
                                        <span className="group-hover:opacity-100 transition-opacity bg-gray-800 p-1 text-sm text-gray-100 rounded-md absolute bottom-10 left-10 -translate-x-10 translate-y-full opacity-0 m-6 mx-auto">
                                            {`https://wong-rho.vercel.app/${id}`}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="flex float-end mt-5">
                                    <Link href={`https://wong-rho.vercel.app/edit`} className="hover:bg-black border hover:text-white border-black text-black font-bold py-2 px-4 rounded">
                                        Create new
                                    </Link>
                                </div>
                            </div>
